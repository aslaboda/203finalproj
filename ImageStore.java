...
final class ImageStore
{
   ...
   public List<PImage> getImageList(String key)
   {
      ...
      // called by worldmodel
      // key is specific instance of entity (sea, bubbles)
   }
   ...
   {
      // this function iterates through each line in imagelist
      // called by loadimages

      String[] attrs = line.split("\\s");
      if (attrs.length >= 2) {
         String key = attrs[0];
         PImage img = screen.loadImage(attrs[1]);
         // attrs[1] is the reference to the actual image in the images file
         // ex: images/wood.bmp
